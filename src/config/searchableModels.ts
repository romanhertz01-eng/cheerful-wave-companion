...
export const searchableModels: SearchableModel[] = [
  ...
  { id: "nb-2-1k", name: "Nano Banana 2", provider: "Google", type: "image", credits: "300", isNew: true },
  ...
  { id: "veo-fast-720p", name: "Veo 3", provider: "Google", type: "video", credits: "480", isNew: true },
