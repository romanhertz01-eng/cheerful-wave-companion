...
const defaultItems: FAQItem[] = [
  { q: "Можно ли попробовать инструменты бесплатно?", a: "Да, при регистрации вы получаете бесплатные кредиты для тестирования всех доступных моделей." },
  ...
  { q: "Что такое кредиты?", a: "Кредиты — это внутренняя валюта платформы. Каждая генерация расходует определённое количество кредитов в зависимости от модели." },
  { q: "Сгорают ли кредиты, если подписка закончилась?", a: "Нет, неиспользованные кредиты сохраняются на вашем балансе и доступны после продления подписки." },
  { q: "Что делать, если кредиты закончились?", a: "Вы можете перейти на более высокий тариф или приобрести дополнительный пакет кредитов." },
  { q: "Языковые модели используют кредиты?", a: "Да, каждый запрос к языковым моделям расходует кредиты. Стоимость зависит от конкретной модели." },
  ...
  { q: "Где посмотреть, как пользоваться инструментами?", a: "В разделе «Гайды» вы найдёте пошаговые инструкции и подробную документацию." },
];
...
const toolPageItems: FAQItem[] = [
  ...
  { q: "Можно ли пользоваться сервисом бесплатно?", a: "Да, при регистрации вы получаете бесплатные кредиты для тестирования всех доступных моделей." },
  ...
  { q: "Как пополнить баланс и оплатить подписку?", a: "Оплата доступна картой российского банка или через СБП. Перейдите в раздел «Тарифы» для выбора плана." },
